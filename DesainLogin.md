      ...
      <div className="w-full max-w-4xl bg-white rounded-t-2xl shadow-2xl overflow-hidden flex flex-col translate-y-12 transition-all duration-300">
        ...
        <div className="p-8 pb-20">
          <div className="mx-auto max-w-md w-full">
            <h2 className="text-2xl font-bold text-gray-800 text-center mb-2">Masuk ke Akun</h2>
            <p className="text-sm text-gray-500 text-center mb-6">Silakan masukkan email dan password Anda</p>
