        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <FadeSection>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">
              Prediksi <span className="text-blue-400">Saham Amerika</span> Serikat
            </h1>
      ...
      <section className="py-20 bg-slate-50 flex-1">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {sahamList.map((saham, index) => {
              const isAvailable = saham.link !== "#";
              return (
                <FadeSection key={saham.id} delay={(index % 3) * 0.1}>
                  <Link
                    href={saham.link}
                    className={`group relative flex flex-col h-full text-left p-6 rounded-2xl border-2 transition-all duration-300 ${
                      isAvailable
